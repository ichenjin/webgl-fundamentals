...
function redrawImg() {
    ...
    */
    ...
    var vertex = [glResources.vertices[0], glResources.vertices[1], 0, 1];
    console.log(m4.transformVector(matrix, vertex));
    console.log(math3d.matrixVectorMultiply(vertex, matrix));
    ...
    console.log(numeric.dot(matrix1, vertex));
}

var webgl_2d_geometry_matrix_transform_hierarchical;
(function (webgl_2d_geometry_matrix_transform_hierarchical) {
    var m3 = {
        identity: function () {
            return [
                1, 0, 0,
    ...
    function main() {
        ...
        setGeometry(gl);
        var scale = new Float32Array([0.8, 0.8]);
        var angleInRadians = 0;
        var translation = new Float32Array([60, 40]);
        var width = 100;
        var height = 30;
    ...
    main();
})(webgl_2d_geometry_matrix_transform_hierarchical || (webgl_2d_geometry_matrix_transform_hierarchical = {}));
